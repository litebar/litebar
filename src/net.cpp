...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Litebar " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    //{"litebartools.com", "dnsseed.litebartools.com"},
    //{"litebarpool.org", "dnsseed.litebarpool.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    //{"litebartools.com", "testnet-seed.litebartools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Litebar is probably already running."), addrBind.ToString().c_str());
        else
